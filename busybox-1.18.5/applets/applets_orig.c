...
enum  {
  LOGMODE_NONE = 0,
  LOGMODE_STDIO = (1 << 0),
  _18_LOGMODE_SYSLOG = ((1 << 1) * 0),
  _19_LOGMODE_SYSLOG = ((1 << 1) * 1),
  _18_LOGMODE_BOTH = (_18_LOGMODE_SYSLOG + LOGMODE_STDIO),
  _19_LOGMODE_BOTH = (_19_LOGMODE_SYSLOG + LOGMODE_STDIO)
} ;
...
int _20_echo_main(int argc , char **argv );
int _21_echo_main(int argc , char **argv ) __attribute__((visibility ("default")));
int _22_printf_main(int argc , char **argv );
int _23_printf_main(int argc , char **argv ) __attribute__((visibility ("default")));
int _24_test_main(int argc , char **argv );
int _25_test_main(int argc , char **argv ) __attribute__((visibility ("default")));
int _26_kill_main(int argc , char **argv );
int _27_kill_main(int argc , char **argv ) __attribute__((visibility ("default")));
int _28_chown_main(int argc , char **argv );
int _29_chown_main(int argc , char **argv ) __attribute__((visibility ("default")));
int _30_ls_main(int argc , char **argv );
int _31_ls_main(int argc , char **argv ) __attribute__((visibility ("default")));
int gunzip_main(int argc , char **argv );
int bunzip2_main(int argc , char **argv );
void _34_bb_displayroutes(int noresolve , int netstatfmt );
...
int _35_in_ib(const  char *bufp , struct  sockaddr   *sap );
...
extern void _36_bb_warn_ignoring_args(char *arg );
...
enum  {
  ...
  _37_PARSE_KEEP_COPY = (0x00200000 * 0),
  _38_PARSE_KEEP_COPY = (0x00200000 * 1),
...
extern char *_39_pw_encrypt(const  char *clear , const  char *salt , int cleanup );
extern char *_40_pw_encrypt(const  char *clear , const  char *salt );
extern int obscure(const  char *old , const  char *newval , const  struct  passwd   *pwdp );
extern int crypt_make_salt(char *p , int cnt , int rnd );
extern int _41_update_passwd(const  char *filename , const  char *username , const  char *data , const  char *member );
extern int _42_update_passwd(const  char *filename , const  char *username , const  char *data );
...
int _43_bb_ioctl_or_warn(int fd , unsigned request , void *argp , const  char *ioctl_name );
int _43_bb_xioctl(int fd , unsigned request , void *argp , const  char *ioctl_name );
int _44_bb_ioctl_or_warn(int fd , unsigned request , void *argp );
int _44_bb_xioctl(int fd , unsigned request , void *argp );
...
typedef struct  line_input_t {
  ...
  int cnt_history ;
  int cur_history ;
  unsigned _45_cnt_history_in_file ;
  const  char *_45_hist_file ;
  char *history[((255 + 0) + 1)] ;
}  line_input_t;
enum  {
  DO_HISTORY = (1 * ((255 + 0) > 0)),
  _46_SAVE_HISTORY = (2 * ((255 + 0) > 0) * 0),
  _45_SAVE_HISTORY = (2 * ((255 + 0) > 0) * 1),
  _47_TAB_COMPLETION = (4 * 0),
  _48_TAB_COMPLETION = (4 * 1),
  _49_USERNAME_COMPLETION = (8 * 0),
  _50_USERNAME_COMPLETION = (8 * 1),
  _51_VI_MODE = (0x10 * 0),
  _52_VI_MODE = (0x10 * 1),
  WITH_PATH_LOOKUP = 0x20,
  _53_FOR_SHELL = (DO_HISTORY | _46_SAVE_HISTORY | _47_TAB_COMPLETION | _49_USERNAME_COMPLETION),
  _54_FOR_SHELL = (DO_HISTORY | _46_SAVE_HISTORY | _48_TAB_COMPLETION | _49_USERNAME_COMPLETION),
  _55_FOR_SHELL = (DO_HISTORY | _46_SAVE_HISTORY | _48_TAB_COMPLETION | _50_USERNAME_COMPLETION),
  _56_FOR_SHELL = (DO_HISTORY | _45_SAVE_HISTORY | _47_TAB_COMPLETION | _49_USERNAME_COMPLETION),
  _57_FOR_SHELL = (DO_HISTORY | _45_SAVE_HISTORY | _48_TAB_COMPLETION | _49_USERNAME_COMPLETION),
  _58_FOR_SHELL = (DO_HISTORY | _45_SAVE_HISTORY | _48_TAB_COMPLETION | _50_USERNAME_COMPLETION)
} ;
...
int _59_procps_read_smaps(pid_t pid , struct  smaprec   *total , void ( *cb)(struct  smaprec   * , void * ) , void *data );
int _60_procps_read_smaps(pid_t pid , struct  smaprec   *total );
typedef struct  procps_status_t {
  ...
  struct  smaprec   _63_smaps ;
  char state[4] ;
  char comm[COMM_LEN] ;
  int _64_last_seen_on_cpu ;
}  procps_status_t;
enum  {
  PSSCAN_PID = (1 << 0),
  PSSCAN_PPID = (1 << 1),
  ...
  PSSCAN_UTIME = (1 << 13),
  PSSCAN_TTY = (1 << 14),
  _65_PSSCAN_SMAPS = ((1 << 15) * 0),
  _63_PSSCAN_SMAPS = ((1 << 15) * 1),
  _66_PSSCAN_ARGVN = ((1 << 16) * (1 || 1 || 1 || 1 || 1)),
  _67_PSSCAN_ARGVN = ((1 << 16) * (1 || 1 || 1 || 1 || 0)),
  _68_PSSCAN_ARGVN = ((1 << 16) * (1 || 1 || 1 || 0 || 1)),
  _69_PSSCAN_ARGVN = ((1 << 16) * (1 || 1 || 1 || 0 || 0)),
  _70_PSSCAN_ARGVN = ((1 << 16) * (1 || 1 || 0 || 1 || 1)),
  _71_PSSCAN_ARGVN = ((1 << 16) * (1 || 1 || 0 || 1 || 0)),
  _72_PSSCAN_ARGVN = ((1 << 16) * (1 || 1 || 0 || 0 || 1)),
  _73_PSSCAN_ARGVN = ((1 << 16) * (1 || 1 || 0 || 0 || 0)),
  _74_PSSCAN_ARGVN = ((1 << 16) * (1 || 0 || 1 || 1 || 1)),
  _75_PSSCAN_ARGVN = ((1 << 16) * (1 || 0 || 1 || 1 || 0)),
  _76_PSSCAN_ARGVN = ((1 << 16) * (1 || 0 || 1 || 0 || 1)),
  _77_PSSCAN_ARGVN = ((1 << 16) * (1 || 0 || 1 || 0 || 0)),
  _78_PSSCAN_ARGVN = ((1 << 16) * (1 || 0 || 0 || 1 || 1)),
  _79_PSSCAN_ARGVN = ((1 << 16) * (1 || 0 || 0 || 1 || 0)),
  _80_PSSCAN_ARGVN = ((1 << 16) * (1 || 0 || 0 || 0 || 1)),
  _81_PSSCAN_ARGVN = ((1 << 16) * (1 || 0 || 0 || 0 || 0)),
  _82_PSSCAN_ARGVN = ((1 << 16) * (0 || 1 || 1 || 1 || 1)),
  _83_PSSCAN_ARGVN = ((1 << 16) * (0 || 1 || 1 || 1 || 0)),
  _84_PSSCAN_ARGVN = ((1 << 16) * (0 || 1 || 1 || 0 || 1)),
  _85_PSSCAN_ARGVN = ((1 << 16) * (0 || 1 || 1 || 0 || 0)),
  _86_PSSCAN_ARGVN = ((1 << 16) * (0 || 1 || 0 || 1 || 1)),
  _87_PSSCAN_ARGVN = ((1 << 16) * (0 || 1 || 0 || 1 || 0)),
  _88_PSSCAN_ARGVN = ((1 << 16) * (0 || 1 || 0 || 0 || 1)),
  _89_PSSCAN_ARGVN = ((1 << 16) * (0 || 1 || 0 || 0 || 0)),
  _90_PSSCAN_ARGVN = ((1 << 16) * (0 || 0 || 1 || 1 || 1)),
  _91_PSSCAN_ARGVN = ((1 << 16) * (0 || 0 || 1 || 1 || 0)),
  _92_PSSCAN_ARGVN = ((1 << 16) * (0 || 0 || 1 || 0 || 1)),
  _93_PSSCAN_ARGVN = ((1 << 16) * (0 || 0 || 1 || 0 || 0)),
  _94_PSSCAN_ARGVN = ((1 << 16) * (0 || 0 || 0 || 1 || 1)),
  _95_PSSCAN_ARGVN = ((1 << 16) * (0 || 0 || 0 || 1 || 0)),
  _96_PSSCAN_ARGVN = ((1 << 16) * (0 || 0 || 0 || 0 || 1)),
  _97_PSSCAN_ARGVN = ((1 << 16) * (0 || 0 || 0 || 0 || 0)),
  _98_PSSCAN_CONTEXT = ((1 << 17) * 0),
  _1_PSSCAN_CONTEXT = ((1 << 17) * 1),
  PSSCAN_START_TIME = (1 << 18),
  _99_PSSCAN_CPU = ((1 << 19) * 0),
  _64_PSSCAN_CPU = ((1 << 19) * 1),
  _100_PSSCAN_NICE = ((1 << 20) * 0),
  _62_PSSCAN_NICE = ((1 << 20) * 1),
  _100_PSSCAN_RUIDGID = ((1 << 21) * 0),
  _62_PSSCAN_RUIDGID = ((1 << 21) * 1),
  _101_PSSCAN_TASKS = ((1 << 22) * 0),
  _61_PSSCAN_TASKS = ((1 << 22) * 1),
  _102_PSSCAN_STAT = (PSSCAN_PPID | PSSCAN_PGID | PSSCAN_SID | PSSCAN_COMM | PSSCAN_STATE | PSSCAN_VSZ | PSSCAN_RSS | PSSCAN_STIME | PSSCAN_UTIME | PSSCAN_START_TIME | PSSCAN_TTY | _100_PSSCAN_NICE | _99_PSSCAN_CPU),
  _103_PSSCAN_STAT = (PSSCAN_PPID | PSSCAN_PGID | PSSCAN_SID | PSSCAN_COMM | PSSCAN_STATE | PSSCAN_VSZ | PSSCAN_RSS | PSSCAN_STIME | PSSCAN_UTIME | PSSCAN_START_TIME | PSSCAN_TTY | _100_PSSCAN_NICE | _64_PSSCAN_CPU),
  _104_PSSCAN_STAT = (PSSCAN_PPID | PSSCAN_PGID | PSSCAN_SID | PSSCAN_COMM | PSSCAN_STATE | PSSCAN_VSZ | PSSCAN_RSS | PSSCAN_STIME | PSSCAN_UTIME | PSSCAN_START_TIME | PSSCAN_TTY | _62_PSSCAN_NICE | _99_PSSCAN_CPU),
  _105_PSSCAN_STAT = (PSSCAN_PPID | PSSCAN_PGID | PSSCAN_SID | PSSCAN_COMM | PSSCAN_STATE | PSSCAN_VSZ | PSSCAN_RSS | PSSCAN_STIME | PSSCAN_UTIME | PSSCAN_START_TIME | PSSCAN_TTY | _62_PSSCAN_NICE | _64_PSSCAN_CPU)
} ;
...
typedef enum bb_install_loc_t {
  ...
  _BB_DIR_BIN,
  _BB_DIR_SBIN,
  _106__BB_DIR_USR_BIN = _BB_DIR_BIN,
  _106__BB_DIR_USR_SBIN = _BB_DIR_SBIN,
  _107__BB_DIR_USR_BIN,
  _107__BB_DIR_USR_SBIN
} bb_install_loc_t;
...
int _108_lbb_main(char **argv ) __attribute__((visibility ("default")));
int _109_lbb_main(char **argv );
_Pragma("GCC visibility pop")
int main(int argc __attribute__((__unused__)), char **argv )  {
  id2i_init();
  if (((id2i.config_feature_shared_busybox ) )) {
    return _108_lbb_main(argv);
  }  
  if ((((! id2i.config_feature_shared_busybox) ) )) {
    return _109_lbb_main(argv);
  }  
}